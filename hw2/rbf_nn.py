...
class RBFLayer(tf.keras.layers.Layer):
    def __init__(self, num_output, kernel_initializer='glorot_uniform', bias_initializer='zeros'):
    ...
    def build(self, input_shape):
        ...
        self.bias = self.add_weight(
            name='bias', shape=(self.num_outputs,),
...
if __name__ == '__main__':
    X = [-100, -90, -80, -79, 0, 1, 2, 3, 50, 100]
    Y = [7, 9, 10, 20, 1, 43, 53, 30, 40, 6]
